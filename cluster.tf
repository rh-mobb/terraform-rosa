...
locals {
  cluster_id                = rhcs_cluster_rosa_hcp.rosa[0].id
  cluster_name              = rhcs_cluster_rosa_hcp.rosa[0].name
  cluster_oidc_config_id    = rhcs_cluster_rosa_hcp.rosa[0].sts.oidc_config_id
  cluster_oidc_endpoint_url = rhcs_cluster_rosa_hcp.rosa[0].sts.oidc_endpoint_url
  cluster_api_url           = rhcs_cluster_rosa_hcp.rosa[0].api_url
  cluster_console_url       = rhcs_cluster_rosa_hcp.rosa[0].console_url
}
